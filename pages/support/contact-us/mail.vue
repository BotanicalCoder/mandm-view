    ...
    <NuxtLayout name="support">
      <template v-slot:header>
        ...
        <div class="flex items-center">
          <Icon name="material-symbols:arrow-back-ios" size="20" color="white" @click="goBack" class="cursor-pointer" />
      ...
      <template #body>
        ...
        <div class="flex flex-col w-full h-full justify-center p-4 items-center gap-2">
          ...
          <div class="text-left flex flex-col gap-4">
            <h3 class="text-gray-800 font-bold text-xl">
              Send us your complaint at
            </h3>
            <p class="text-gray-800 font-thin text-lg">

              <span class="font-normal"> support@moremoneemfb.com</span>

              <br />

              <span class="font-normal"> support@moremoneegroup.com</span>
            </p>

            <!-- <form class="flex flex-col gap-4 items-center" @submit.prevent="sendEmail">
              ...
              <textarea
                ...
                placeholder="Enter description.." v-model="complaint.description">
      </textarea>
              <button
