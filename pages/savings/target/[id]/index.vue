  ...
  <div>
    <NuxtLayout name="savings">
      ...
      <div class="flex flex-col p-4 gap-4" v-else>
        ...
        <div class="w-full text-white text-center h-fit bg-[#3861b4] rounded-lg p-3">
        ...
        <div class="flex flex-col gap-1">
          ...
          <progress-bar :goal="parseFloat(data?.data[0].save_target || '0')"
        ...
        <div class="grid grid-cols-2 justify-between gap-6 mt-4">
          ...
          <div class="flex flex-col items-start">
            <p class="text-sm"> Next Saving Date</p>
            <h4 class="font-medium text-base capitalize">
              {{
                getNextDebitTime(
                  data?.data[0].when_debit,
                  data?.data[0].debit_day_time
                )
              }}
            </h4>
          </div>
          ...
          <div class="flex flex-col items-start">
            ...
            <h4 class="font-medium text-base capitalize" :class="[
