            ...
            <div class="flex flex-col p-3 border bg-[white] text-black rounded-lg"
              ...
              <div class="grid grid-cols-2 gap-3">
                <div class="flex flex-col col-span-2 text-lg">
                  <!-- <p> Name </p> -->
                  <h4 class="font-bold capitalize truncate">{{ transactionsData.narration }}
                  </h4>
                </div>
...
const { data, pending, error } = await useAsyncData<RootObj>(
  'all-fixed-savings-transactions',
  () => $fetch('https://kams.kolomoni.ng/api/savings/view-fixed-savings-transactions', {
    method: "get",
    headers: {
